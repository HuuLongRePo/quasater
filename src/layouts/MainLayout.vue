<template>
  <q-layout view="lHr lpR fFf">
    ...
    <q-header bordered class="bg-white text-black">
      <q-toolbar>
        ...
        <q-toolbar-title class="text-weight-bold">
          <span class="gt-sm">Quasater</span>
      <q-icon name="fas fa-dove" class="q-pa-md lt-md header-icon" size="sm" color="primary" />
    ...
    <q-drawer show-if-above v-model="leftDrawerOpen" side="left" :width="283" bordered>
      <q-icon name="fas fa-dove" class="q-pa-md" size="lg" color="primary" />
      <q-list>
    ...
    <q-drawer show-if-above v-model="rightDrawerOpen" side="right" bordered>
      <q-input placeholder="Search Quasater" outlined rounded dense class="q-ma-md">
